import unittest
import csv
from langchain_openai import match_questions
...
class TestQuestionMatching(unittest.TestCase):
    ...
    def setUp(self):
        self.csv_file = open("src/langchain/mismatches_tweaked_langchain_openai.csv", "w", newline='')
    ...
    def test_matching(self):
        ...
        for idx, user_input in enumerate(tweakedQuestionsWithGrammarMistakes):
            ...
            results = match_questions(realisticQuestions, user_input)
