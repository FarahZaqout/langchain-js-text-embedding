...
from ensemble_voting_average import match_questions, questions, user_inputs


class TestQuestionMatching(unittest.TestCase):

    def setUp(self):
        self.csv_file = open("src/sentence_transformers/averages_mismatches.csv", "w", newline='')
