...
*    a list of question from the notebook project with more questions added to it
*    the list of tweaked questions that produced a mismatch in the notebook project.
*    4 tweaked variations of the same list of questions (generated by chatgpt).
